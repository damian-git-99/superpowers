...
2. Check if `.pi/commands/opsx-ff.md` exists (slash commands registered)

**If either is missing, warn the user:**

> "OpenSpec is not set up in this project. Run: `openspec init --tools pi`"
...
Run once per project. Registers slash commands in `.pi/commands/`.
